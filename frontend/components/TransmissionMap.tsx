...
const TransmissionNodeCard = memo(function TransmissionNodeCard({
  ...
  return (
    <div
      className={cn(
        "w-56 rounded-lg border p-3 shadow-[0_16px_50px_rgba(0,0,0,0.28)] backdrop-blur",
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm text-muted-foreground">
              Interactive-looking map of how rate cuts can move from policy
              shock to Canadian bank fundamentals and valuation drivers.
            </p>
          </div>
          <Badge variant="data">Visual centerpiece</Badge>
        </div>
      </CardHeader>
      <CardContent className="p-0">
        <div className="grid min-h-[680px] lg:grid-cols-[1fr_280px]">
          <div className="relative min-h-[620px] border-b border-white/10 bg-[radial-gradient(circle_at_20%_20%,rgba(8,145,178,0.12),transparent_28%),linear-gradient(180deg,rgba(24,24,27,0.92),rgba(9,9,11,0.96))] lg:border-b-0 lg:border-r">
            <ReactFlow
              nodes={flowNodes}
              edges={flowEdges}
              nodeTypes={nodeTypes}
